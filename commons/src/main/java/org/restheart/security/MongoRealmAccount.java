...
public class MongoRealmAccount extends PwdCredentialAccount implements WithProperties<BsonDocument> {
    ...
    /**
     * Returns the MongoDB database name associated with this account.
     * 
     * <p>This identifies which database contains the user's account information, enabling
     * multi-tenant architectures where different users may be stored in different databases.
     * The database name can be used for:</p>
     * <ul>
     *   <li>Routing database operations to the correct tenant database</li>
     *   <li>Implementing database-level access controls</li>
     *   <li>Auditing and logging with tenant context</li>
     * </ul>
     * 
     * @return The database name where this user account is stored
     */
    public String db() {
        return this.db;
    }
