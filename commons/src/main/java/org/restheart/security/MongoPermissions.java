 ...
 *
 * <p>
 * This class represents the MongoDB-specific portion of ACL permissions, defined by the `mongo`
 * property in permission configurations. It provides granular control over various aspects of
 * MongoDB operations including read/write filtering, request manipulation, and operation restrictions.
 * </p>
 *
 ...
 * <p>
 * Filters support variable interpolation using {@link AclVarsInterpolator}, allowing dynamic
...
public class MongoPermissions {
     ...
     *
     * <p>
     * This constant provides a convenient way to grant unrestricted MongoDB access. It has:
     * </p>
     * <ul>
     ...
     *
     * <p>
     * <strong>Security Warning:</strong> Use with caution. This should only be assigned to
     ...
     *
     * <p>
     * This default constructor creates the most restrictive permissions where:
     * </p>
     * <ul>
     ...
     *
     * <p>
     * This is suitable as a base for building up specific permissions or when
     * MongoDB access should be completely restricted.
     * </p>
     */
     ...
     *
     * <p>
     * This method extracts MongoDB-specific permissions from the ACL permission that
     * authorized the request. It looks for the raw permission data attached to the request
     * and converts it to a MongoPermissions instance.
     * </p>
     *
     * <p>
     * The method handles various formats of permission data:
     * </p>
     * <ul>
     ...
     *
     * @param request
     *            The request to extract permissions from
     * @return The MongoPermissions for this request, or default permissions if none are found
     * @throws ConfigurationException
     *             if the permission data is malformed
     * @throws IllegalArgumentException
     *             if the permission data type is not supported
     ...
     *
     * <p>
     * This method extracts the raw permission data from the ACL permission and converts
     * it to MongoDB-specific permissions. This is useful when working directly with permission
     * objects rather than requests.
     * </p>
     *
     * @param p
     *            The ACL permission containing MongoDB permission data in its raw field
     ...
     *
     * <p>
     * This factory method handles conversion from various data formats to MongoPermissions.
     * It serves as the central parsing point for all permission data sources.
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * Any other type will result in an IllegalArgumentException.
     * </p>
     *
     * @param raw
     *            The raw permission data in one of the supported formats
     * @return A MongoPermissions instance based on the input data
     * @throws ConfigurationException
     *             if the data structure is invalid or contains bad values
     * @throws IllegalArgumentException
     ...
     *
     * <p>
     * This method parses a BSON document containing MongoDB permission settings. The document
     * should have a "mongo" field containing the permission configuration. If the "mongo" field
     * is missing or null, default permissions are returned.
     * </p>
     *
     ...
     *
     * <p>
     * The method handles BSON type conversions and validates boolean fields. Invalid
     * configurations will result in a ConfigurationException with details about the error.
     * </p>
     *
     * @param doc
     *            The BSON document containing permission configuration
     * @return A MongoPermissions instance based on the document
     * @throws ConfigurationException
     *             if the document structure is invalid or contains invalid values
     * @see #from(Map)
     */
     ...
     *
     * <p>
     * This method creates a BSON document containing all permission settings, which can be
     * used for serialization, logging, or passing permissions to other components. Only non-null
     * values and non-false boolean flags are included in the output.
     * </p>
     *
     ...
     *
     * <p>
     * This method parses MongoDB permission settings from a map structure, typically
     * loaded from configuration files. It supports the following properties:
     * </p>
     *
     * <table border="1">
     * <tr>
     ...
     * <td>readFilter</td>
     * <td>String/Doc</td>
     * <td>MongoDB filter for read operations</td>
     * <td>null</td>
     * </tr>
     * <tr>
     * <td>writeFilter</td>
     * <td>String/Doc</td>
     * <td>MongoDB filter for write operations</td>
     * <td>null</td>
     * </tr>
     * <tr>
     * <td>mergeRequest</td>
     * <td>String/Doc</td>
     * <td>Data to merge into requests</td>
     * <td>null</td>
     * </tr>
     * <tr>
     * <td>projectResponse</td>
     * <td>String/Doc</td>
     * <td>Response projection</td>
     * <td>null</td>
     * </tr>
     * <tr>
     * <td>allowManagementRequests</td>
     * <td>Boolean</td>
     * <td>Allow database/collection management</td>
     * <td>false</td>
     * </tr>
     * <tr>
     * <td>allowBulkPatch</td>
     * <td>Boolean</td>
     * <td>Allow bulk PATCH operations</td>
     * <td>false</td>
     * </tr>
     * <tr>
     * <td>allowBulkDelete</td>
     * <td>Boolean</td>
     * <td>Allow bulk DELETE operations</td>
     * <td>false</td>
     * </tr>
     * <tr>
     * <td>allowWriteMode</td>
     * <td>Boolean</td>
     * <td>Allow ?wm query parameter</td>
     * <td>false</td>
     * </tr>
     * </table>
     *
     * <p>
     * Filter and document properties can be specified as:
     * </p>
     * <ul>
     ...
     *
     * @param args
     *            The configuration map containing MongoDB permission settings
     ...
     *
     * <p>
     * This helper method extracts and validates boolean configuration values from a Map-based
     * permission configuration. It provides consistent error handling and default values.
     * </p>
     *
     * @param args
     *            The configuration map containing permission settings
     * @param key
     *            The key to look up in the configuration map
     ...
     *
     * <p>
     * This helper method extracts and validates boolean configuration values from a BSON-based
     * permission configuration. It handles BSON type checking and provides consistent error messages.
     * </p>
     *
     * @param args
     *            The BSON document containing permission settings
     * @param key
     *            The key to look up in the BSON document
     * @return The boolean value if present and valid, false if not present (default)
     * @throws ConfigurationException
     *             if the value exists but is not a boolean
     */
     ...
     *
     * <p>
     * This filter is automatically combined with user queries to restrict which documents
     ...
     *
     * <p>
     * This filter restricts which documents can be modified or deleted. Write operations
     * that would affect documents not matching this filter are rejected. For example, a filter
     * of {@code { "owner": "@user" }} ensures users can only modify their own documents.
     * </p>
     *
     ...
     *
     * <p>
     * This document is merged with request bodies before processing, allowing permissions
     * to inject required fields. Common uses include:
     * </p>
     * <ul>
     ...
     *
     * <p>
     * This projection controls which fields are included or excluded in responses, following
     * MongoDB projection syntax. Examples:
     * </p>
     * <ul>
     ...
     *
     * <p>
     * Management requests include operations that create, modify, or delete databases
     * and collections. This flag must be true to allow:
     * </p>
     * <ul>
     ...
     *
     * <p>
     * Bulk PATCH operations allow updating multiple documents in a single request using
     * MongoDB's bulk write API. This is more efficient than individual updates but requires
     * additional permissions due to its potential impact.
     * </p>
     *
     ...
     *
     * <p>
     * Bulk DELETE operations allow removing multiple documents matching a filter in a
     * single request. This flag must be true to allow operations that could potentially
     * delete large numbers of documents.
     * </p>
     *
     ...
     *
     * <p>
     * The write mode parameter (?wm) allows clients to control how writes are handled:
     * </p>
     * <ul>
     ...
     *
     * <p>
     * When false, the server's default write mode is used.
     * </p>
     *
