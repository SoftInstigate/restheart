...
```bash
$ cd core
$ docker build -f Dockerfile.native . -t softinstigate/restheart:6.6.0-native -t softinstigate/restheart:latest-native
$ docker push softinstigate/restheart:6.6.0-native
