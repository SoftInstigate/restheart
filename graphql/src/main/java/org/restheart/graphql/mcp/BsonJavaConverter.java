...
/**
 * Recursively converts a {@link BsonValue} into the plain {@code Map}/{@code List}/scalar shape
 * the MCP framework's {@code McpResource} expects — used wherever this package reads a value out
 * of {@code gql-apps} metadata that needs to cross into that plain-Java world. Mirrors
 * {@code org.restheart.mongodb.mcp.BsonJavaConverter} (same need, package-private in each module
 * rather than shared, since it's a small, self-contained conversion with no state).
 */
