...
public final class QueryBuilder {
    ...
    private QueryBuilder(String _db, String _name, String _collection, boolean _multiple){
        this.db = _db;
        this.name = _name;
    ...
    public static QueryBuilder newBuilder(String _db, String _name, String _collection, boolean _multiple){
        return new QueryBuilder(_db, _name, _collection, _multiple);
    }
    ...
    public Query build(){
        ...
        return new Query(db, name, collection, multiple, filter, sort, skip, limit, first);
    }
