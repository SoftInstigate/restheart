...
public class MetricsHandlerTest {
    ...
    private void assertRequestContextForMetricsRequest(MongoRequest request, String expectedDatabaseName,
    ...
    private void assertMetricsLevelForRequest(String resourceUri,
            MongoServiceConfiguration.METRICS_GATHERING_LEVEL expectedLevelForConfigOff,
            MongoServiceConfiguration.METRICS_GATHERING_LEVEL expectedLevelForConfigRoot,
            MongoServiceConfiguration.METRICS_GATHERING_LEVEL expectedLevelForConfigDatabase,
    ...
    public void testMetricsRegistryForRequestToCollection() {
        ...
        verify(handler.metrics, times(1)).registry(eq(requestContext.getDBName()),
                eq(requestContext.getCollectionName()));
    }
